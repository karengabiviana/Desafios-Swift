...
/**
 * Label implementing the Body-1 style of Circuit UI Mobile.
 * Modify the `variant` property to use the different variants of the Body-1 style.
 */
NS_SWIFT_NAME(LabelBody1)
@interface CUILabelBody1 : CUILabel
