//
//  CUIButtonOnColoredBackgroundLightSecondary.h
//  CircuitUI
//
...
/**
 * Button to be used on colored backgrounds only, using the Light appearance and Secondary variant of Circuit UI Mobile.
 */
NS_SWIFT_NAME(ButtonOnColoredBackgroundLightSecondary)
@interface CUIButtonOnColoredBackgroundLightSecondary : CUIButtonOnColoredBackground
