//
//  CUIButtonOnColoredBackgroundLightPrimary.h
//  CircuitUI
//
...
/**
 * Button to be used on colored backgrounds only, using the Light appearance and Primary variant of Circuit UI Mobile.
 */
NS_SWIFT_NAME(ButtonOnColoredBackgroundLightPrimary)
@interface CUIButtonOnColoredBackgroundLightPrimary : CUIButtonOnColoredBackground
