...
/**
 * Button using the Giga size and Tertiary variant of Circuit UI Mobile.
 */
NS_SWIFT_NAME(ButtonGigaTertiary)
@interface CUIButtonGigaTertiary : CUIDefaultButton
