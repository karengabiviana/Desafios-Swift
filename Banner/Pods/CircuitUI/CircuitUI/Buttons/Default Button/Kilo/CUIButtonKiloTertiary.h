...
/**
 * Button using the Kilo size and Tertiary variant of Circuit UI Mobile.
 */
NS_SWIFT_NAME(ButtonKiloTertiary)
@interface CUIButtonKiloTertiary : CUIDefaultButton
